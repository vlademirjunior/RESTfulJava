package br.com.restfuljava.integrationtests.controllers.withjson;
...
import br.com.restfuljava.integrationtests.dto.wrappers.json.WrapperPersonDTO;
...
class PersonControllerJsonTest extends AbstractIntegrationTest {
    ...
    void createTest() throws JsonProcessingException {
        ...
        assertEquals("Junior", createdPerson.getLastName());
        assertEquals("RJ - BRAZIL", createdPerson.getAddress());
    ...
    void updateTest() throws JsonProcessingException {
        person.setLastName("Benedict Junior");
        ...
        assertEquals("Vlademir", createdPerson.getFirstName());
        assertEquals("Benedict Junior", createdPerson.getLastName());
        assertEquals("RJ - BRAZIL", createdPerson.getAddress());
        assertEquals("Male", createdPerson.getGender());
        assertTrue(createdPerson.getEnabled());
