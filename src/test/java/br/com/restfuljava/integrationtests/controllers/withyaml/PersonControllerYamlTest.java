package br.com.restfuljava.integrationtests.controllers.withyaml;

import br.com.restfuljava.config.TestConfigs;
import br.com.restfuljava.integrationtests.controllers.withyaml.mapper.YAMLMapper;
...
import br.com.restfuljava.integrationtests.dto.wrappers.xmlandyaml.PagedModelPerson;
...
class PersonControllerYamlTest extends AbstractIntegrationTest {
    ...
    void signin() throws JsonProcessingException {
        AccountCredentialsDTO credentials = new AccountCredentialsDTO("vlad", "admin123");
    ...
    void createTest() throws JsonProcessingException {
        ...
        var createdPerson = given().config(
                RestAssuredConfig.config()
                        .encoderConfig(
                                EncoderConfig.encoderConfig().encodeContentTypeAs(MediaType.APPLICATION_YAML_VALUE,
                                        ContentType.TEXT)))
                .spec(specification)
                .contentType(MediaType.APPLICATION_YAML_VALUE)
                .accept(MediaType.APPLICATION_YAML_VALUE)
        ...
        assertEquals("Vlademir", createdPerson.getFirstName());
        assertEquals("Manoel", createdPerson.getLastName());
    ...
    void updateTest() throws JsonProcessingException {
        person.setLastName("Benedict Manoel");
        ...
        assertEquals("Vlademir", createdPerson.getFirstName());
        assertEquals("Benedict Manoel", createdPerson.getLastName());
        assertEquals("Helsinki - Finland", createdPerson.getAddress());
        assertEquals("Male", createdPerson.getGender());
        assertTrue(createdPerson.getEnabled());
    ...
    void findByNameTestTest() throws JsonProcessingException {
        ...
        assertEquals("Bertrando", personOne.getFirstName());
        assertEquals("Becconsall", personOne.getLastName());
        assertEquals("35 Dryden Junction", personOne.getAddress());
        assertEquals("Male", personOne.getGender());
        ...
        assertEquals("Kandy", personFour.getFirstName());
        assertEquals("Colquhoun", personFour.getLastName());
        assertEquals("92 Doe Crossing Crossing", personFour.getAddress());
    ...
    void hateoasAndHalTest() throws JsonProcessingException {
        ...
        for (Map<String, Object> person : content) {
            ...
            for (Map<String, String> link : links) {
                ...
                assertThat("HATEOAS/HAL link " + link + " has an invalid URL", link.get("href"),
                        matchesPattern("https?://.+/api/person/v1.*"));
            }
        }
        ...
        for (Map<String, String> pageLink : pageLinks) {
            ...
            assertThat("HATEOAS/HAL page link " + pageLink + " has an invalid URL", pageLink.get("href"),
                    matchesPattern("https?://.+/api/person/v1.*"));
        }
    }

    private void mockPerson() {
        person.setFirstName("Vlademir");
        person.setLastName("Manoel");
        person.setAddress("Helsinki - Finland");
        person.setGender("Male");
        person.setEnabled(true);
        person.setProfileUrl("https://vlademir.dev");
        person.setPhotoUrl("https://vlademir.dev");
    }
}