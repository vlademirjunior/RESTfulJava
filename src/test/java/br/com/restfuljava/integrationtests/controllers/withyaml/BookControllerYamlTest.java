...
import br.com.restfuljava.integrationtests.dto.BookDTO;
import br.com.restfuljava.integrationtests.dto.TokenDTO;
import br.com.restfuljava.integrationtests.dto.wrappers.xmlandyaml.PagedModelBook;
...
class BookControllerYamlTest extends AbstractIntegrationTest {
    ...
    void findAllTest() throws JsonProcessingException {
        ...
        assertEquals("The Art of Computer Programming, Volume 1: Fundamental Algorithms", bookOne.getTitle());
        assertEquals("Donald E. Knuth", bookOne.getAuthor());
        assertEquals(110.74, bookOne.getPrice());
        ...
        assertEquals("The Art of Computer Programming, Volume 2: Seminumerical Algorithms", foundBookSeven.getTitle());
        assertEquals("Donald E. Knuth", foundBookSeven.getAuthor());
        assertEquals(42.85, foundBookSeven.getPrice());
    }
